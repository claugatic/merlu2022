...
3 #_Forecast recruitment:  0= spawn_recr; 1=value*spawn_recr_fxn; 2=value*VirginRecr; 3=recent mean) 
...
2000 # Rebuilder:  first year catch could have been set to zero (Ydecl)(-1 to set to 1999)97
2018 #15 Rebuilder:  year for current age structure (Yinit) (-1 to set to endyear+1)20
2 # fleet relative F:  1=use first-last alloc year; 2=read seas, fleet, alloc list below
# Note that fleet allocation is used directly as average F if Do_Forecast=4 
2 # 2 basis for fcast catch tuning and for fcast catch caps and allocation  (2=deadbio; 3=retainbio; 5=deadnum; 6=retainnum)
